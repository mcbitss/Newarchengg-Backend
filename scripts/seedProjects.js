...
const sampleProjects = [
  {
    ...
    description: 'A sophisticated residential development featuring 14 luxury villa units with modern architectural design and premium finishes. This project showcases contemporary Middle Eastern architecture with elegant proportions.',
  ...
  },
  {
    ...
    description: 'Contemporary villa complex with three units, featuring innovative design and sustainable building practices. Each villa offers spacious living areas and private gardens.',
    location: 'Satwa',
    year: 2022,
  ...
  },
  {
    ...
    description: 'Alternative perspective of the Satwa villa development, showcasing the elegant façade design and landscaping integration.',
    location: 'Satwa',
    year: 2022,
    client: 'Residential Developer',
    category: 'villa',
  ...
  },
  {
    ...
    description: 'Ground plus one villa design featuring modern architecture with traditional elements. Spacious interiors and premium finishes throughout.',
  ...
  },
  {
    ...
    description: 'Another perspective of the Khawaneej villa development showcasing the architectural diversity.',
    location: 'Khawaneej 2nd',
    year: 2021,
    client: 'Private Owner',
    category: 'villa',
  ...
  },
  {
    ...
    description: 'Modern residential tower with ground floor plus two parking levels and six residential floors. Features contemporary design with efficient space planning.',
  ...
  },
  {
    ...
    description: 'Alternative view of the Nad Al Sheba residential tower showing the building\'s relationship to its surroundings.',
    location: 'Nad Al Sheba',
    year: 2023,
    client: 'Property Group',
    category: 'residential',
  ...
  },
  {
    ...
    description: 'High-rise residential building with comprehensive parking facilities and modern amenities. Designed for optimal living comfort.',
    location: 'Satwa',
    year: 2022,
  ...
  },
  {
    ...
    description: 'Third perspective of the Satwa residential building showing additional architectural details.',
    location: 'Satwa',
    year: 2022,
    client: 'Development Company',
    category: 'residential',
  ...
  },
  {
    ...
    description: 'Ground plus three floors combining residential and commercial spaces. Strategic location with excellent visibility.',
    location: 'Satwa',
    year: 2021,
  ...
  },
  {
    ...
    description: 'Ground floor with mezzanine plus one floor combining commercial and residential functions. Modern design with flexible space planning.',
  ...
  },
  {
    ...
    description: 'Ground plus mezzanine plus one floor development in Muteena area. Contemporary design with efficient space utilization.',
    location: 'Muteena',
    year: 2020,
  ...
  },
  {
    ...
    description: 'Mixed-use development combining residential units with ground floor commercial spaces. Strategic design for maximum functionality.',
    location: 'Souq Al Kabeer',
    year: 2020,
    client: 'Mixed-Use Developer',
    category: 'mixed',
  ...
  },
  {
    ...
    description: 'Ground plus mezzanine plus two floors of mixed-use development. Features modern architecture with efficient space planning.',
    location: 'Souq Al Kabeer',
    year: 2019,
  ...
  },
  {
    ...
    description: 'Larger scale mixed-use development with ground, mezzanine, and three upper floors. Comprehensive design for residential and commercial use.',
    location: 'Souq Al Kabeer',
    year: 2018,
    client: 'Commercial Developer',
    category: 'mixed',
  ...
  // Additional projects using project-XX.jpg files
  {
    ...
    description: 'Premium residential development featuring high-end finishes and modern amenities. Designed for discerning clients seeking luxury living.',
    location: 'Dubai',
    year: 2023,
  ...
  },
  {
    ...
    description: 'Collection of contemporary villas featuring innovative design and sustainable building practices.',
    location: 'Dubai',
    year: 2022,
  ...
  },
  {
    ...
    description: 'Exclusive villa estate featuring custom-designed homes with private gardens and premium finishes.',
    location: 'Dubai',
    year: 2022,
    client: 'Luxury Developer',
    category: 'villa',
  ...
  },
  {
    ...
    description: 'Contemporary office complex designed for modern businesses with flexible workspace solutions.',
    location: 'Dubai',
    year: 2021,
    client: 'Commercial Developer',
    category: 'commercial',
  ...
  },
  {
    ...
    description: 'Modern commercial plaza featuring retail spaces, restaurants, and entertainment facilities.',
    location: 'Dubai',
    year: 2022,
  ...
  },
  {
    ...
    description: 'Contemporary development showcasing innovative architecture and sustainable design principles.',
    location: 'Dubai',
    year: 2022,
    client: 'Development Company',
    category: 'mixed',
